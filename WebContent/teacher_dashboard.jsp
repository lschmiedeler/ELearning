  	...
  	<body>
	    ...
	    <tbody>
	    	<tr align = "center" valign = "top">
    			...
    			<td>
    				<s:iterator var="i" step="1" value="studentList">
    	...
    	<a href="<s:url action='enterNewCourseInfo'/>"  style="font-size: 20px">Create Course</a>
    	<br>
    	<a href="<s:url action='enterNewAssignmentInfo'/>"  style="font-size: 20px">Create Assignment</a>
    	<br>
    	<a href="<s:url action='selectCourseForGrades'/>"  style="font-size: 20px">Enter Grades</a>
    	<br>
    	<a href="<s:url action='selectCourseForGradesView'/>"  style="font-size: 20px">View Grades</a>
    	<br>
