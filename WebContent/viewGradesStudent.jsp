  			...
  			<!-- Define colgroup to specify spacing -->
  				...
  				<thead>
  					<tr>
  						...
  						<th onclick="sortTable(1)" align="center">Course Name</th>
  				...
  				<tbody>
  					<s:iterator var="i" step="1" value="gradeListStudent">
	  					<tr>
  						<td style="display: none;" align="center">0</td>
                			<td align="center"><s:property value="%{assignmentCourse}"></s:property></td>
                			<td align="center"><s:property value="%{assignmentName}"></s:property></td>
